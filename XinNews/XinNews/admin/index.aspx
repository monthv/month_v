<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="XinNews.admin.index" %>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="hollow.aspx" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="add.aspx" name="right" width="100%" height="100%"></iframe>
</div>
