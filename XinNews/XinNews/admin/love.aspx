<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="love.aspx.cs" Inherits="XinNews.admin.love" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="width: 50px" Text="修改" />
