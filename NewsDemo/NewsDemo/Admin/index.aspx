<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="NewsDemo.Admin.index" %>
...
<div class="leftnav">
  ...
  <ul>
    <li><a href="list.aspx" target="right"><span class="icon-caret-right"></span>内容管理</a></li>
    <li><a href="add.html" target="right"><span class="icon-caret-right"></span>添加内容</a></li>
    <li><a href="cate.aspx" target="right"><span class="icon-caret-right"></span>分类管理</a></li>        
  </ul>  
</div>
