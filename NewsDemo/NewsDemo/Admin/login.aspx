<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="NewsDemo.Admin.login" %>
        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div style="padding:30px;"><%--<input type="submit" class="button button-block bg-main text-big input-big" value="登录">--%>
                    <asp:Button ID="Button1" runat="server" Text="登录"  class="button button-block bg-main text-big input-big" value="登录" OnClick="Button1_Click"/>
                </div>
            </div>
