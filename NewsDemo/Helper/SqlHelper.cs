...
namespace WXLoDC.DBUtility
{
    public class SqlHelper
    {
        ...
        public static readonly string SQLConnString1 = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        ...
        public static int GetSingle2(string connectionString, string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static bool DoBool(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(SQLConnString1))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    try
