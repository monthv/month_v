<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication10.WebForm2" %>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="column.html" target="right"><span class="icon-caret-right"></span>栏目管理</a></li>
      <li><a href="WebForm1.aspx" target="right"><span class="icon-caret-right"></span>查询</a></li>
      <li><a href="WebForm2.aspx" target="right"><span class="icon-caret-right"></span>添加</a></li>
  </ul>   
